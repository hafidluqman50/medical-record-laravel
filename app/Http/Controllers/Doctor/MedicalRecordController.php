...
class MedicalRecordController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Doctor/MedicalRecord/Index', compact('medical_records', 'page_num'));
    }

    public function create(?int $registration_id = null): Response
    {
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->intended('/doctor/medical-records')->with('success', 'Berhasil Input Rekam Medis!');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    {   
        ...
        return Inertia::render('Doctor/MedicalRecord/ListRecord', compact('medical_record_lists', 'page_num'));
    }
    ...
    public function delete(int $id): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->intended('/doctor/medical-records')->with('success', 'Berhasil Hapus Rekam Medis!');
        } catch (Exception $e) {
            DB::rollBack();
