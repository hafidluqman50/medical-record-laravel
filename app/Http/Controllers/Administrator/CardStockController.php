...
class CardStockController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $card_stocks = CardStock::when($medicine_batch_number != '' && $from_date != '' && $to_date != '', function(Builder $query) use ($medicine_batch_number, $from_date, $to_date) {
                $query->whereBetween('date_stock',[$from_date,$to_date])
