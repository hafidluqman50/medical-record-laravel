...
export default function Create({
  ...
  const selectRegistrationAct = async (value: number): Promise<void> => {
    ...
    try {
      const responseData = await axios.get<AxiosGetRegistration>(
        route("api.medical-records.get-registration-by-id", value),
      );
  ...
  const submitForm: FormEventHandler = (e) => {
    ...
    post(route("administrator.medical-records.store"));
  };
            ...
            <div className="mb-4 border-b-2 border-slate-200 py-4">
              ...
              >
                ...
                <TabsContent value="catatan-medis">
                  <div className="mb-4 border-b-2 border-slate-200 py-4">
                    <Button variant="secondary" asChild>
                      <Link href={route("administrator.medical-records")}>
                        Kembali
                      </Link>
                    </Button>
                  </div>
                  <form onSubmit={submitForm}>
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          selectRegistrationAct(parseInt(value))
                        }
                      >
                        ...
                        <SelectContent>
                          {registrations.map((row, key) => (
                            <SelectItem value={row.id.toString()} key={key}>
                              {row.number_register} | {row.patient.name} |{" "}
                              {row.doctor.name}
                            </SelectItem>
                          ))}
                        </SelectContent>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex">
                        <Input
                          ...
                          name="body_height"
                          value={
                            data.body_height == null ? "" : data.body_height
                          }
                          className="mt-1 block w-full"
                          autoComplete="body_height"
                          onChange={(e) =>
                            setData("body_height", parseFloat(e.target.value))
                          }
                        />
                        <Button
                          variant="ghost"
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex">
                        <Input
                          ...
                          name="body_weight"
                          value={
                            data.body_weight == null ? "" : data.body_weight
                          }
                          className="mt-1 block w-full"
                          autoComplete="body_weight"
                          onChange={(e) =>
                            setData("body_weight", parseFloat(e.target.value))
                          }
                        />
                        <Button
                          variant="ghost"
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex">
                        <Input
                          ...
                          onChange={(e) =>
                            setData("body_temp", parseFloat(e.target.value))
                          }
                        />
                        <Button
                          variant="ghost"
                    ...
                    <div className="mt-4">
                      <InputLabel
                        htmlFor="complains_of_pain"
                        value="Keluhan Penyakit"
                      />
                      ...
                      <Textarea
                        ...
                        cols={30}
                        onChange={(e) =>
                          setData("complains_of_pain", e.target.value)
                        }
                      />

                      <InputError
                        message={errors.complains_of_pain}
                        className="mt-2"
                      />
                    </div>
                    ...
                    <div className="mt-4">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setData("physical_examinations", e.target.value)
                        }
                      />

                      <InputError
                        message={errors.physical_examinations}
                        className="mt-2"
                      />
                    </div>
                    ...
                    <div className="mt-4">
                      <InputLabel
                        htmlFor="supporting_examinations"
                        value="Pemeriksaan Penunjang"
                      />
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setData("supporting_examinations", e.target.value)
                        }
                      />

                      <InputError
                        message={errors.supporting_examinations}
                        className="mt-2"
                      />
                    </div>
                    ...
                    <div className="mt-4">
                      <InputLabel
                        htmlFor="lab_action_id"
                        value="Tindakan Lab"
                      />

                      <Select
                        onValueChange={(value) =>
                          setData("lab_action_id", parseInt(value))
                        }
                      >
                        <SelectTrigger className="w-full">
                    ...
                    <div className="mt-4">
                      <InputLabel
                        htmlFor="next_control_date"
                        value="Tanggal Kontrol Selanjutnya"
                      />
                      ...
                      <Input
                        ...
                        className="mt-1 block w-full"
                        onChange={(e) =>
                          setData("next_control_date", e.target.value)
                        }
                      />

                      <InputError
                        message={errors.next_control_date}
                        className="mt-2"
                      />
                    </div>
                ...
                <TabsContent value="data-tindakan">
                  <div className="mx-auto max-w-2xl rounded-lg border-2 border-stone-100 p-4 backdrop-blur-lg">
