...
export default function Index({auth, app, customers, page_num}: PageProps & CustomerProps) {
    ...
    const submitDelete = (id: number): void => {
        router.delete(route('administrator.customers.delete', id))
    }
    ...
    return (
        <AdministratorLayout
            ...
            routeChild="pelanggan-kredit"
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Data Pelanggan</h2>}
        >
                        ...
                        <div className="flex">
                            <div className="grow">
                                <Button className="mb-2" asChild>
                                    <Link href={route('administrator.customers.create')}>Tambah Pelanggan</Link>
                                </Button>
                            </div>
                        ...
                        <Table className="border-collapse border border-slate-200">
                          <TableHeader>
                            <TableRow>
                              ...
                              <TableHead className="border border-slate-200">Nomor Debitur</TableHead>
                                        ...
                                        <TableCell className="border border-slate-200">
                                            <div className="flex space-x-4">
                                                <Button className="bg-amber-500 text-white hover:bg-amber-500" asChild>
                                                    <Link href={route('administrator.customers.edit', row.id)}>Edit</Link>
                                                </Button>
                                                <AlertDialog>
                                                  ...
                                                  <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                      ...
                                                      <AlertDialogDescription>
                                                        This action cannot be undone. This will delete your customers data from our servers.
                                                      </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                            ...
                            <TableRow>
                                <TableCell colSpan={6}>
                                    <Pagination>
                                        <PaginationContent>    
                                    {
                                        customers.links.map((pagination, key) => (
