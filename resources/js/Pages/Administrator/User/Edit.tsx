...
export default function Edit({auth, user, roles}: PageProps & EditPageProps) {
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg py-8 px-8">
                        ...
                        <form onSubmit={submitForm}>
                            ...
                            <div className="mt-4">
                                ...
                                <Select defaultValue={user.role_id.toString()} onValueChange={(value) => setData('role_id', parseInt(value))}>
