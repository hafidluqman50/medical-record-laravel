...
interface ReceivingMedicineForm {
    order:Array<{
        medicine_id: number,
...
export default function Create({auth, invoice_number}: PageProps & CreateFormProps) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm<ReceivingMedicineForm>({
        order:[],
        invoice_number,
        date_receive:'',
        total_grand:0,
    ...
    const submitForm: FormEventHandler = (e) => {
        ...
        post(route('administrator.receiving-medicines.store'));
    }
    ...
    return(
        <AdministratorLayout
            ...
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Form Penerimaan Obat</h2>}
        >
            <Head title="Form Penerimaan Obat" />
                ...
                <div className="w-full mx-auto sm:px-6 lg:px-8 flex space-x-4">
                    <div className="w-4/12 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg py-8 px-8">
                        ...
                        <div className="grid grid-cols-1">
                            <div>
                                <InputLabel htmlFor="invoice_number" value="Kode Penerimaan" />
                            ...
                            <div className="mt-4">
                                <InputLabel htmlFor="date_receive" value="Tanggal Penerimaan" />
                    ...
                    <div className="w-8/12 h-1/2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg py-8 px-8">
                        ...
                        <div className="mt-4 w-full border-t-2 border-slate-200 py-4">
                            <Button ref={btnInputRef} onClick={() => inputActPenerimaan()}>Input</Button>
                        </div>
                    </div>
                </div>
                        ...
                        <Table className="border-collapse border border-slate-200">
                            <TableHeader>
                                <TableRow>
                                  ...
                                  <TableHead className="border-slate-200">Keterangan</TableHead>
                            ...
                            <TableBody>
                            {
                                rowOrders.length == 0 ? 
                                <TableRow>
                                    <TableCell colSpan={9} align="center">Empty Data!</TableCell>
                                </TableRow> : 
