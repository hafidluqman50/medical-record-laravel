...
export default function Create({auth, drug_classification}: PageProps & EditFormProps) {

    const { data, setData, put, processing, errors, reset } = useForm<DrugClassificationForm>({
        name:drug_classification.name,
        is_prekursor:drug_classification.is_prekursor,
        is_narcotic:drug_classification.is_narcotic,
        is_psychotropic:drug_classification.is_psychotropic
    });

    const submitForm: FormEventHandler = (e) => {
        e.preventDefault()

        put(route('administrator.drug-classifications.update', drug_classification.id));
    }
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg py-8 px-8">
                        ...
                        <form onSubmit={submitForm}>
                            ...
                            <div className="mt-4">
                                ...
                                <Select defaultValue={drug_classification.is_prekursor.toString()} onValueChange={(value) => setData('is_prekursor', parseInt(value))}>
                            ...
                            <div className="mt-4">
                                ...
                                <Select defaultValue={drug_classification.is_narcotic.toString()}  onValueChange={(value) => setData('is_narcotic', parseInt(value))}>
                                  <SelectTrigger className="w-full">
                            ...
                            <div className="mt-4">
                                ...
                                <Select defaultValue={drug_classification.is_psychotropic.toString()}  onValueChange={(value) => setData('is_psychotropic', parseInt(value))}>
                                  <SelectTrigger className="w-full">
