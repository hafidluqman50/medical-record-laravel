...
export default function TransactionHv({kode_transaksi, price_parameter, medicine_price_parameters}: TransactionUpdsPageProps) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm<HvForm>({
        indexObat:null,
        medicine_id:[],
        price:[],
        qty:[],
    ...
    const [faktor, setFaktor]                         = useState<string>('HV')
            ...
            <div className="grid grid-cols-4 gap-4 mt-4 mb-4">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex space-x-4">
                        ...
                        <div>
                            <Input ref={faktorRef} className="bg-slate-200" type="text" value={faktor == 'HV' ? 'HV' : 'UPDS'} readOnly/>
                        </div>
                    </div>
                    <div className="flex space-x-4">
                        <div className="w-2/6">
