...
export default function Index({
  ...
  medical_suppliers,
  page_num,
}: PageProps<MedicalSupplierProps>) {
            ...
            <div className="flex">
              <div className="grow">
                <Button className="mb-2" asChild>
                  <Link href={route("administrator.medical-suppliers.create")}>
                      ...
                      <TableCell className="border border-slate-200">
                        <div className="flex space-x-4">
                          ...
                          >
                            <Link
                              href={route(
                                "administrator.medical-suppliers.edit",
                                row.id,
                              )}
                            >
                              Edit
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  your medical supplier data from our servers.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
